...
//register title font
Font.register({family: 'Great Vibes', src: "http://fonts.gstatic.com/s/greatvibes/v4/6q1c0ofG6NKsEhAc2eh-3Z0EAVxt0G0biEntp43Qt6E.ttf" });
...
const CertificateDocument: React.FC<CertificateDocumentProps> = ({ name = "Name here", date = "Date here", course = "Course here" }) => (
    <Document>
