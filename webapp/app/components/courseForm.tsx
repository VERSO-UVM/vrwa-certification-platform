...
export function NewCourseForm({ onCreate, course }) {
    ...
    return (
        <Form onSubmit={handleSubmit} className="space-y-6 p-4">
            <FieldGroup>
                <Field>
                    <FieldLabel htmlFor="courseName">Course <span className="text-destructive">*</span></FieldLabel>
                    <Input
                        id="courseName"
                        type="text"
                        required
                ...
                <Field>
                    <FieldLabel htmlFor="creditHours">Credit Hours <span className="text-destructive">*</span></FieldLabel>
                    <Input
                        id="creditHours"
                        type="number"
                        required
                        value={values.creditHours}
                        onChange={(e) => setValues({...values, creditHours: Number(e.target.value)})}
                        >
                    </Input>
                </Field>
                <Field>
