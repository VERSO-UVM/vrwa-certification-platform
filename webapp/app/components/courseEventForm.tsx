...
import { Calendar } from "~/components/ui/calendar"; import { Button } from "~/components/ui/button";
...
export function NewCourseEventForm({ onCreate }) {
    ...
    return (
        <Form onSubmit={handleSubmit} className="space-y-6 p-4">
            <FieldGroup>
                <Field>
                    <FieldLabel htmlFor="courses">Course <span className="text-destructive">*</span></FieldLabel>
                    <Select
                        required
                ...
                <Field>
                    <FieldLabel htmlFor="seats">Seats <span className="text-destructive">*</span></FieldLabel>
                    <Input
                        id="seats"
                        type="number"
                        min={1}
                        required
                        value={values.seats}
                        onChange={(e) => setValues({...values, seats: Number(e.target.value)})}
                    />
                </Field>
                <Field>
                    <FieldLabel htmlFor="locationType">Location Type <span className="text-destructive">*</span></FieldLabel>
                    <Select
                ...
                <Field>
                    ...
                    <Input
                        ...
                        onChange={(e) => setValues({...values, physicalAddress: e.target.value })}
                        />
                </Field>
                <Field>
                ...
                <Field>
                    <FieldLabel htmlFor="time">Time <span className="text-destructive">*</span></FieldLabel>
                    <Input
                        id="time"
                        type="time"
                        required 
