      ...
      <div className="grid gap-4 grid-cols-1 @xl:grid-cols-8">
        <Card className="@xl:col-span-8">
          ...
          <div className="flex justify-end mb-4 pr-4">
            <Button variant="secondary" size="lg" onClick={() => {setSelectedEvent(null); setCourseEventDrawerOpen(true);}}>+ Create New Course Event</Button>
            <Drawer 
              direction="right"
            ...
            >
              <DrawerContent>
                <DrawerHeader>
                  <DrawerTitle>{(selectedEvent) ? "Edit Course Event": "New Course Event"}</DrawerTitle>
                  <DrawerDescription>{(selectedEvent) ? "Make changes to an existing course event": "Create a new course event for an existing class"}</DrawerDescription>
                </DrawerHeader>
