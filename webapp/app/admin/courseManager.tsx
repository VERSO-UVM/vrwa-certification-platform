...
export function CourseManager() {
    ...
    function editRow(row: CourseEvent) {
        ...
        const dateTime = row.classStartDatetime ? new Date(row.classStartDatetime) : undefined;
    ...
    const columns: ColumnDef<CourseEvent>[] = [
        ...
        cell: ({ row }) =>
            ...
            ) : row.original.classStartDatetime ? (new Date(row.original.classStartDatetime).toLocaleString()
        ) : ( "-" ),
        },
